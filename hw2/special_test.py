...
def test(model_path='./', datadir='./data', outfilepath='special.csv'):
    ...
    ixtoword = pd.Series(np.load(join(datadir, 'basic_ixtoword.npy')).tolist())
    
    bias_init_vector = np.load(join(datadir, 'basic_bias_init_vector.npy'))
    ...
    generated_sentences = []
    index = []
    for video in ['klteYv1Uv9A_27_33.avi.npy', '5YJaS2Eswg0_22_26.avi.npy', 'UbmZAe5u5FI_132_141.avi.npy',
                  'JntMAcTlOF0_50_70.avi.npy', 'tJHUH9tpqPg_113_118.avi.npy']:
        print('video =>', video)
